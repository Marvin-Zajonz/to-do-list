...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/marvinzajonz/PycharmProjects/flaskProject/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/marvinzajonz/PycharmProjects/flaskProject/venv/bin/deactivate.nu'
